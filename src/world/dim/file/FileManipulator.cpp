...
void FileManipulator::commitChunk(Chunk& chunk) {
	...
	std::string chunkData = chunk.compressToString();
...
void
FileManipulator::shiftChunks(std::fstream& file, std::array<short, 4096>& offsets, unsigned int ind, unsigned int amt) {
